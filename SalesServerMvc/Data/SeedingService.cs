...
using SalesServerMvc.Models.Enums;

namespace SalesServerMvc.Data
{
    public class SeedingService
    {
        private SalesServerMvcContext _context;

        public SeedingService(SalesServerMvcContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria green", "maria@gmail.com", new DateTime(1979,12, 31), 1500.00, d3);
            Seller s3 = new Seller(3, "Alex grey", "alex@gmail.com", new DateTime(1997, 8, 5), 2000.00, d4);
            Seller s4 = new Seller(4, "Martha red", "martha@gmail.com", new DateTime(1959, 7, 1), 3000.00, d2);
            Seller s5 = new Seller(5, "Donald blue", "donald@gmail.com", new DateTime(2001, 7, 12), 1850.00, d2);
            Seller s6 = new Seller(6, "Alex pink", "alex@gmail.com", new DateTime(2005, 11, 28), 1000.00, d4);
